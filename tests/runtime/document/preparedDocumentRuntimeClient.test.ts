import { createPreparedDocumentRuntimeClient } from "../../../src/runtime/runtime-blazor/src/preparedDocumentRuntimeClient.js";
...
{
  const result = await client.openPreparedDocumentSession({ sessionId: "prepared-session", documentId: "prepared-document" });
