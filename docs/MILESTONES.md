...
| `milestones/milestone-0021-layer2-json-schema-overlay-over-prepared-documents.md` | Implemented / synchronized | Adds the read-only Layer 2 JSON Schema overlay over prepared-document Layer 1 sessions. |
