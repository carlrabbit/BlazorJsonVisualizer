...
export function createPreparedDocumentRuntimeClient(bridge: PreparedDocumentDotNetBridge): PreparedDocumentRuntimeClient {
  return {
    openPreparedDocumentSession: (request) => bridge.invokeMethodAsync<PreparedOpenResultDto>("OpenPreparedDocumentSessionAsync", request),
    getPreparedDocumentMetadata: (sessionId) => bridge.invokeMethodAsync<PreparedDocumentMetadataDto>("GetPreparedDocumentMetadataAsync", sessionId),
    getPreparedRows: (request) => bridge.invokeMethodAsync<PreparedRowsResultDto>("GetPreparedRowsAsync", request),
    readPreparedTextRange: (request) => bridge.invokeMethodAsync<PreparedTextRangeDto>("ReadPreparedTextRangeAsync", request),
